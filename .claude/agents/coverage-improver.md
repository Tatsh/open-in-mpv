...
1. Run `uv run pytest --cov open_in_mpv --cov-branch --cov-report term-missing:skip-covered`
...
4. Run `uv run pytest --cov open_in_mpv --cov-branch --cov-report term-missing:skip-covered`
