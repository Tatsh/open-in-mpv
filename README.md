...
[![GitHub commits since latest release (by SemVer including pre-releases)](https://img.shields.io/github/commits-since/Tatsh/open-in-mpv/v0.1.1/master)](https://github.com/Tatsh/open-in-mpv/compare/v0.1.1...master)
