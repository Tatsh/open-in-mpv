...
[![GitHub commits since latest release (by SemVer including pre-releases)](https://img.shields.io/github/commits-since/Tatsh/open-in-mpv/v0.2.0/master)](https://github.com/Tatsh/open-in-mpv/compare/v0.2.0...master)
...
Uninstall the extension from your browser. Then follow the steps below depending on how you
installed the native messaging host component:
